...
export const PERMISSIONS = {
  ...
  VIDEOS_PERMANENT_DELETE: "videos:permanent_delete",
  USERS_MANAGE: "users:manage",
  USERS_MANAGE_COMPANY: "users:manage_company",
  /** Edit staff profile fields (name, email, phone, status-linked settings). */
  USERS_EDIT: "users:edit",
  USERS_DEACTIVATE: "users:deactivate",
  /** Permanent Auth + profile removal (platform owner/admin). */
  USERS_DELETE: "users:delete",
  USERS_CHANGE_ROLE: "users:change_role",
  USERS_CHANGE_PRESENTATION_POLICY: "users:change_presentation_policy",
...
const PLATFORM_ADMIN_PERMISSIONS: readonly Permission[] = [
  ...
  PERMISSIONS.VIDEOS_PERMANENT_DELETE,
  ...
  PERMISSIONS.USERS_CHANGE_PRESENTATION_POLICY,
