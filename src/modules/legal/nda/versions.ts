...
export const NDA_VERSIONS: readonly NdaVersionRecord[] = [
  ...
  },
  {
    ...
    originalPdfLocation: "/legal/nda/v1.1.0/Serenity-1-Consulting-NDA.pdf",
    title: "NON-DISCLOSURE AND LIABILITY WAIVER AGREEMENT",
    pdfSha256:
      "cacb25ccf225aa070bfd88ad920685965053c4ccdcf1c3da08df8194cabe345a",
  },
] as const;
...
/**
 * Plain-text body for Firestore / acceptance hash twin (v1.0.0 historical).
 * Do not use for new publishes.
 */
...
/**
 * Plain-text twin for NDA v1.1.0 (electronic acceptance wording).
 * Must stay aligned with NdaDocumentHtml §8 and the v1.1.0 PDF.
 */
export const NDA_V1_1_PLAIN_TEXT = `Welcome to our informational seminar about some very exciting new programs we have to offer. We are very pleased to let you know that over the past several years, we have been able to successfully help clients obtain refunds related to their timeshare ownership. Once the attached NDA has been signed, we will begin and provide you with all of the information you came today to hear.
